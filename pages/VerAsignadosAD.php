<?php
 ...
 ?>
<?php
    require("../php/getAsignadosAD.php");

    $asignedProducts = new GetAsignedInventory();
    $getAsignedProducts = $asignedProducts->showAsignedInventoryRecords();
?>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                    <h1 class="page-header alert alert-info">Detalle de Asignaciones</h1>
            </div>
            <!-- /.row -->
            <div class="row">
                ...
                <br><br>
                    ...
                    <table width="100%" class="table table-striped table-hover" id="inventario">
                        ...
                        <tbody>
                            <?php
                                foreach ($getAsignedProducts as $key) {
                                    echo "<tr><td>";
                                    echo $key["Fecha"] . "</td><td>";
                                    echo $key["Departamento"] . "</td><td>";
                                    echo $key["CodigoArticulo"] . "</td><td>";
                                    echo $key["NombreArticulo"] . "</td><td>";
                                    echo $key["Cantidad"] . "</td><td>";
                                    echo $key["Bodega"] . "</td><td>";
