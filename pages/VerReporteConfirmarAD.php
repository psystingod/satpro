...
<?php
    ...
    $a=$_GET['v'];
    $detalleAsigna = $detalleAsignacion->detalleAsignacionesPendientes($a);
...
<body>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <form action="../php/ReporteConfirmarAd.php" method="POST">
      <br> <br>
        ...
        foreach($detalleAsigna as $res)
          {
            ?>
             ...
             <tr>
                ...
                <tr>
                  <td COLSPAN="2" width="150" HEIGHT="20">Departamento:</td>
       ...
       <?php
            ...
            ?>
                    ...
                    <a href="DetalleDeAsignaciones.php"><button class="btn btn-default" type="button" name="regresar"><i class="fas fa-arrow-circle-left"></i> Regresar</button></a>
