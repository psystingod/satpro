                          ...
                          <div class="modal-body">
                              <div class="form-row">
                                  <div class="form-group col-md-12 col-xs-12">
                                      ...
                                      <input type="text" class="form-control" name="usuario"  placeholder="Escriba el nombre de usuario" pattern="[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?\s?[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?" title="Escribir solamente letras" required>
                                  </div>
                              </div>
                              ...
                              <div class="form-row">
                                <div class="form-group col-md-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="clave" placeholder="Escriba la contraseña" title="Puede escribir combinación de letras y números" required>
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="form-group col-md-12 col-xs-12">
