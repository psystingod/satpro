      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <h1 class="page-header alert alert-info">Unidades de Medida</h1>
                    <?php
            ...
            <div class="row">
                ...
                <button  title="Presione: Alt+A" class="btn btn-primary pull-right" type="button" name="button" data-toggle="modal" data-target="#agregar" accesskey="a"><i class="fas fa-plus-circle"></i> Agregar Nueva Unidad de Medida</button>
                <br><br>
                        ...
                        <tbody>
                          <?php
                              foreach ($Bodegas as $key) {
                                  echo "<tr><td>";
                                  echo $key["NombreUnidadMedida"] . "</td><td width='150' >";
                                  echo $key["Abreviatura"] . "</td><td width='200' >";
                                    if( $key["state"] == 0)
                                    {
                                  ...
                                  echo "<div class='btn-group pull-right'>
                                              ...
                                              <ul class='dropdown-menu'>
                                                  <li><a href='actualizarUnidadMedida.php?Id={$key["IdUnidadMedida"]}'><i class='fas fa-edit'></i> Editar</a>
                                                  </li>
                                                  ";
                                                  if( $key["state"] == 1)
                                                  {
                                                    echo "
                                                    <li><a href='php/updateUnidadMedida.php?Id={$key["IdUnidadMedida"]}'><i class='fas fa-edit'></i>Activar</a>
                                                    </li>
                                                    ";
                                                  }
                                                  else {
                                                  echo  "
                                                    <li><a href='php/updateUnidadMedida.php?Id={$key["IdUnidadMedida"]}'><i class='fas fa-edit'></i>Desactivar</a>
                                                    </li>
                                                    ";
                                                  }
                                                  "
    ...
    <div class="modal fade" id="agregar" tabindex="-1" role="dialog" aria-labelledby="agregar">
          <div class="modal-dialog" role="document">
                <div class="modal-content">
                      ...
                      <form action="php/saveUnidadMedida.php" method="POST">
                      <div class="modal-body">
                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                          <label for="codigo">Nombre:</label>
                                          <input type="text" class="form-control" name="NombreUnidadMedida"  placeholder="Nombre de la Unidad de Medida" pattern="[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?\s?[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?" title="Escribir solamente letras" required>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-4 col-xs-4">
                                        ...
                                        <input type="text" class="form-control" name="Abreviatura" placeholder="Abrev" pattern="[a-zA-Z]+\s?[a-zA-Z]+?" title="Escribir solamente letras" required>
                                    </div>
                                  </div>
                      </div>
