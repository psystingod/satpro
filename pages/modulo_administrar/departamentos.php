      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <h1 class="page-header alert alert-info">Departamentos de la Empresa</h1>
                    <?php
            ...
            <div class="row">
                <form class="" action="" method="POST">
                  ...
                  <button   class="btn btn-primary pull-left" type="submit" name="button1" onclick="javascript: form.action='../asignarEncargadoDepartamento.php' "><i class="fas fa-plus-circle"></i> Asignar Encargado</button>
                <button  title="Presione: Alt+A" class="btn btn-primary pull-right" type="button" name="button" data-toggle="modal" data-target="#agregar" accesskey="a"><i class="fas fa-plus-circle"></i> Agregar Nuevo Departamento</button>
                <br><br>
                    ...
                    <table class="table table-striped table-hover" id="inventario" >
                        ...
                        <tbody>
                          <?php
                              ...
                              //    echo $key["Codigo"] ." " . $key["Nombres"] . "</td><td >";
                                //  echo $key["Codigo"] . "</td><td >";
                                  ...
                                  echo "<div class='btn-group pull-right'>
                                              ...
                                              <ul class='dropdown-menu'>
                                                  <li><a href='actualizarDepartamento.php?Id={$key["IdDepartamento"]}'><i class='fas fa-edit'></i> Editar</a>
                                                  </li>
                                                  ";
                                                  if( $key["State"] == 1)
                                                  {
                                                    echo "
                                                    <li><a href='php/updateDepartamento.php?Id={$key["IdDepartamento"]}'><i class='fas fa-edit'></i>Activar</a>
                                                    </li>
                                                    ";
                                                  }
                                                  else {
                                                  echo  "
                                                    <li><a href='php/updateDepartamento.php?Id={$key["IdDepartamento"]}'><i class='fas fa-edit'></i>Desactivar</a>
                                                    </li>
                                                    ";
                                                  }
                                                  "
          ...
          <div class="modal-dialog" role="document">
                <div class="modal-content">
                      <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="nuevoProducto">Nuevo Departamento</h4>
                      </div>
                      ...
                      <div class="modal-body">
                                  ...
                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                            ...
                                            <textarea class="form-control" name="Descripcion" placeholder="Breve Descripcion del Departamento"></textarea>
                                      </div>
                                  </div>
                      </div>
