      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <h1 class="page-header alert alert-info">Bodegas</h1>
                    <?php
            ...
            <div class="row">
                ...
                <button  title="Presione: Alt+A" class="btn btn-primary pull-right" type="button" name="button" data-toggle="modal" data-target="#agregar" accesskey="a"><i class="fas fa-plus-circle"></i> Agregar Nueva Bodega</button>
                <br><br>
          ...
          <div class="modal-dialog" role="document">
                <div class="modal-content">
                      <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="nuevoProducto">Nueva Bodega</h4>
                      </div>
                      <form action="php/saveBodega.php" method="POST">
                      <div class="modal-body">
                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                          <label for="codigo">Nombre</label>
                                          <input type="text" class="form-control" name="Nombre" id="nombre" placeholder="Bodega [NOMBRE]" pattern="[a-zA-Záéíóú]+\s[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?" title="Escriba solamente letras y números" required>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                            ...
                                            <textarea class="form-control" name="Direccion" id="descripcion" placeholder="Agregue Direccion completa de la Bodega" required></textarea>
                                      </div>
                                  </div>
                      </div>
