      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <h1 class="page-header alert alert-info">Plazas</h1>
                    <?php
                        ...
                        <tbody>
                          <?php
                              foreach ($Plazas as $key) {
                                  echo "<tr><td>";
                                  echo $key["nombrePlaza"] . "</td><td width='150' >";
                                  echo $key["descripcionPlaza"] . "</td><td width='200' >";
                                  ...
                                  echo "<div class='btn-group pull-right'>
                                              ...
                                              <ul class='dropdown-menu'>
                                                  <li><a href='actualizarPlaza.php?Id={$key["idPlaza"]}'><i class='fas fa-edit'></i> Editar</a>
                                                  </li>
                                                  <li class='divider'></li>
                                              </ul>
                                          </div>" . "</td></tr>";
          ...
          <div class="modal-dialog" role="document">
                <div class="modal-content">
                      <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="nuevoProducto">Nueva Plaza</h4>
                      </div>
                      <form action="php/savePlaza.php" method="POST">
                      <div class="modal-body">
                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                          <label for="Nombre">Nombre de  la plaza</label>
                                          <input type="text" class="form-control" name="NombrePlaza" id="nombrePlaza" placeholder="Nombre de Plaza" required>
                                      </div>
                                  </div>

                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                            <label for="message-text" class="control-label">Descripcion de la plaza:</label>
                                            <textarea class="form-control" name="DescripcionPlaza" id="descriptionPlaza" placeholder="Descripcion" required></textarea>
                                      </div>
                                  </div>
                      </div>
