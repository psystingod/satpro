...
<?php
    ...
    try {
        ...
        $query = "SELECT  IdCategoria, NombreCategoria, Descripcion, State from tbl_categoria where IdCategoria= ?";
...
if($_POST)
{
    try{
        ...
        $query = "UPDATE tbl_categoria set NombreCategoria= :NombreCategoria, Descripcion=:Descripcion where IdCategoria=:IdCategoria";

        // prepare query for excecution
        $stmt = $con->prepare($query);

        // POSTed values
        $IdCategoria=htmlspecialchars(strip_tags($_POST['IdCategoriaa']));
        $Nombre=htmlspecialchars(strip_tags($_POST['NombreCategoria']));
...
?>
 <h1 class="page-header alert alert-info">Actualmente Mirando Categoria: <?php echo htmlspecialchars($Nombre, ENT_QUOTES);  ?></h1>
                    <?php
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?Id={$IdCategoria}");?>" method="POST">
        <input type="hidden" name="IdCategoriaa" value="<?php echo htmlspecialchars($IdCategoria, ENT_QUOTES);  ?>" >
        <table class='table table-hover table-responsive table-bordered'>

            <tr>
                <td>Nombre: </td>
                <td colspan="3"><input type="text" name="NombreCategoria" value="<?php echo htmlspecialchars($Nombre, ENT_QUOTES);  ?>" class='form-control'></td>
            </tr>
            <tr>
                <td>Descripciòn: </td>
