      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <h1 class="page-header alert alert-info">Categorias</h1>
                    <?php
            ...
            <div class="row">
                ...
                <button  title="Presione: Alt+A" class="btn btn-primary pull-right" type="button" name="button" data-toggle="modal" data-target="#agregar" accesskey="a"><i class="fas fa-plus-circle"></i> Agregar Nueva Categoria</button>
                <br><br>
                    ...
                    <table class="table table-striped table-hover" id="inventario" >
                        ...
                        <tbody>
                          <?php
                              foreach ($Cate as $key) {
                                  echo "<tr><td>";
                                  echo $key["NombreCategoria"] . "</td><td >";
                                  ...
                                  echo "<div class='btn-group pull-right'>
                                              ...
                                              <ul class='dropdown-menu'>
                                                  <li><a href='actualizarCategoria.php?Id={$key["IdCategoria"]}'><i class='fas fa-edit'></i> Editar</a>
                                                  </li>
                                                  ";
                                                  if( $key["State"] == 1)
                                                  {
                                                    echo "
                                                    <li><a href='php/updateCategoria.php?Id={$key["IdCategoria"]}'><i class='fas fa-edit'></i>Activar</a>
                                                    </li>
                                                    ";
                                                  }
                                                  else {
                                                  echo  "
                                                    <li><a href='php/updateCategoria.php?Id={$key["IdCategoria"]}'><i class='fas fa-edit'></i>Desactivar</a>
                                                    </li>
                                                    ";
                                                  }
          ...
          <div class="modal-dialog" role="document">
                <div class="modal-content">
                      <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="nuevoProducto">Nueva Categoría</h4>
                      </div>
                      <form action="php/saveCategoria.php" method="POST">
                      <div class="modal-body">
                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                          <label for="codigo">Nombre</label>
                                          <input type="text" class="form-control" name="NombreCategoria" placeholder="Nombre de la categoria" pattern="[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?\s?[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?" title="Escribir solamente letras" required>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                            ...
                                            <textarea class="form-control" name="Descripcion" placeholder="Agregue Descripcion breve de la Categoria"></textarea>
                                      </div>
                                  </div>
                      </div>
