...
<body>
      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <h1 class="page-header alert alert-info">Porcentajes de AFP</h1>
                    <?php
                    ...
                    <table class="table table-striped table-hover" id="inventario" >
                        ...
                        <tbody>
                          <?php
                              foreach ($Afp as $key) {
                                  echo "<tr><td>";
                                  echo $key["nombre_afp"] . "</td><td width='150' >";
                                  echo $key["porcentaje_afp"] . "</td><td width='200' >";
                                  echo $key["fecha"] . "</td><td width='150' >";
                                  echo $key["estado"] . "</td><td width='200' >";
                                  echo "<div class='btn-group pull-right'>
                                              ...
                                              <ul class='dropdown-menu'>
                                                  <li><a href='actualizarAfp.php?Id={$key["id_afp"]}'><i class='fas fa-edit'></i> Editar</a>
                                                  </li>
                                                  <li class='divider'></li>
                                              </ul>
                                          </div>" . "</td></tr>";
          ...
          <div class="modal-dialog" role="document">
                <div class="modal-content">
                      <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="nuevoProducto">Nuevo Porcentaje de AFP</h4>
                      </div>
                      <form action="php/saveAfp.php" method="POST">
                      <div class="modal-body">
                                  <div class="form-row">
                                      <div class="form-group col-md-8 col-xs-8">
                                          <label for="Nombre">Nombre</label>
                                          <input type="text" class="form-control" name="nombreAfp" id="nombreAfp" placeholder="Nombre AFP" required>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-row">
                                      <div class="form-group col-md-4 col-xs-4">
                                          ...
                                          <input type="text" class="form-control" name="fechaAfp" id="fechaAfp" placeholder="" required>
                                      </div>
                                  </div>

                                  <div class="form-row">
                                      <div class="form-group col-md-6 col-xs-6">
                                            <label for="message-text" class="control-label">Porcentaje AFP (%):</label>
                                            <input type="number" min="0" max="100"  step="0.01" class="form-control" name="porcentajeAfp" id="porcentajeAfp" placeholder="0.0" required>
                                      </div>
                                      <div class="form-group col-md-6 col-xs-6">
                                            <!-- <label for="message-text" class="control-label">Decimal AFP:</label>
                                          <input type="text" class="form-control" name="pAfp1" id="pAfp1" placeholder="" readonly> -->
                                          <br>
                                      </div>
                                  </div>
                      </div>
    ...
    <script type="text/javascript">
        ...
        document.getElementById("fechaAfp").value = d.getFullYear()+"/"+month+"/"+d.getDate();
    </script>
