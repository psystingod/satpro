      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <h1 class="page-header alert alert-info">Tipos de Productos</h1>
                    <?php
            ...
            <div class="row">
                ...
                <button  title="Presione: Alt+A" class="btn btn-primary pull-right" type="button" name="button" data-toggle="modal" data-target="#agregar" accesskey="a"><i class="fas fa-plus-circle"></i> Agregar Nuevo Tipo Producto</button>
                <br><br>
                    ...
                    <table class="table table-striped table-hover" id="inventario" >
                        ...
                        <tbody>
                          <?php
                              foreach ($Tipo as $key) {
                                  echo "<tr><td>";
                                  echo $key["NombreTipoProducto"] . "</td><td >";
                                    if( $key["state"] == 0)
                                    {
                                  ...
                                  echo "<div class='btn-group pull-right'>
                                              ...
                                              <ul class='dropdown-menu'>
                                                  <li><a href='actualizarTipoProducto.php?Id={$key["IdTipoProducto"]}'><i class='fas fa-edit'></i> Editar</a>
                                                  </li>
                                                  ";
                                                  if( $key["state"] == 1)
                                                  {
                                                    echo "
                                                    <li><a href='php/updateTipoProducto.php?Id={$key["IdTipoProducto"]}'><i class='fas fa-edit'></i>Activar</a>
                                                    </li>
                                                    ";
                                                  }
                                                  else {
                                                  echo  "
                                                    <li><a href='php/updateTipoProducto.php?Id={$key["IdTipoProducto"]}'><i class='fas fa-edit'></i>Desactivar</a>
                                                    </li>
                                                    ";
                                                  }
          ...
          <div class="modal-dialog" role="document">
                <div class="modal-content">
                      <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="nuevoProducto">Nuevo tipo de producto</h4>
                      </div>
                      <form action="php/saveTipoProducto.php" method="POST">
                      <div class="modal-body">
                                  <div class="form-row">
                                      <div class="form-group col-md-12 col-xs-12">
                                          <label for="codigo">Nombre</label>
                                          <input type="text" class="form-control" name="NombreTipoProducto" placeholder="Nombre del tipo de producto" pattern="[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?\s?[a-zA-Záéíóú]+\s?[a-zA-Záéíóú]+?" title="Escribir solamente letras" required>
                                      </div>
                                  </div>
                      </div>
