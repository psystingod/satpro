...
<?php
    ...
    try {
        ...
        $query = "SELECT IdArticulo, Codigo, NombreArticulo, Descripcion, Cantidad, PrecioCompra, PrecioVenta, FechaEntrada FROM tbl_articulo WHERE IdArticulo = ? LIMIT 0,1";
...
?>
    ...
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            <td>Nombre</td>
            <td><?php echo htmlspecialchars($nombreArticulo, ENT_QUOTES);  ?></td>
        </tr>
        <tr>
            <td>Descripción</td>
        ...
        <tr>
            ...
            <td><?php echo htmlspecialchars("$".$precioC, ENT_QUOTES);  ?></td>
        </tr>
        <tr>
            <td>Precio de venta</td>
            <td><?php echo htmlspecialchars("$".$precioV, ENT_QUOTES);  ?></td>
        </tr>
        <tr>
