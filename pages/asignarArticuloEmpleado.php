      ...
      <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <button id="traslados" type="submit" class="btn btn-default pull-left" disabled = "disabled" accesskey="t" onclick="javascript: form.action='resumenArticuloEmpleado.php' "><i class="fas fa-users"></i> Asignar Articulo Seleccionado a un Empleado</button>
