                ...
                */
                      ...
                      while($row = $resultado->fetch_assoc())
                      {
                         ...
                         $pdf->SetFont('Arial','',6.5);
                          ...
                          $query5 = "SELECT numeroFactura, fechaFactura, mesCargo FROM tbl_cargos WHERE codigoCliente='".$row['codigoCliente']."' AND mesCargo='".$row['mesCargo']."' AND tipoServicio='".$row['tipoServicio']."' AND fechaFactura='".$hasta."' AND anulada='".$anulada."'";
              ...
              if ($codigoCobrador != "todos") {
                ...
                *//// finalizacion de obtenencion de datos de la tabla cargos para liquidar los abonos
                          ...
                          if ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
                              ...
                              $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND cobradoPor= '".$cobradorR."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                          }
                      }elseif ($tipoServicio == "C") {
                                        ///// inicio de obtenencion de datos de la tabla cargos para liquidar los abonos
