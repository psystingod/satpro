...
function abonos(){
    ...
    if (isset($detallado)){
        if ($detallado == 1){
            ...
            $pdf->Cell(190, 4, utf8_decode('LISTADO DE ANTICIPOS LIQUIDADOS'), 0, 1, 'L');
                ...
                while ($cobradores = $statement1->fetch_assoc()) {//RECORRIDO DE TODOS LOS COBRADORES
                    ...
                    if($tipoServicio === "A") {
                        ...
                        if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                            $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND anulada= '".$anulada."' AND cobradoPor= '".$cobradorR."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);

                        }elseif ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] != "todas") {
                            $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND idColonia= '".$colonia."' AND codigoCobrador= '".$cobradorR."' AND anulada= '".$anulada."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);
                        }
                    }elseif ($tipoServicio == "C") {
                        if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                            $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND anulada= '".$anulada."' AND tipoServicio= '".$tipoServicio."' AND cobradoPor= '".$cobradorR."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);
                        }elseif ($_POST["lCobrador"] == "todos" && $_POST["lColonia"] != "todas") {
                            $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND idColonia= '".$colonia."' AND cobradoPor= '".$cobradorR."' AND tipoServicio= '".$tipoServicio."' AND anulada= '".$anulada."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);
                        }
                    ...
                    while($row = $resultado->fetch_assoc())
                    {
                        ...
                        $pdf->Cell(10,1,utf8_decode($counter3),0,0,'L');
                ...
                while ($cobradores = $statement1->fetch_assoc()) {//RECORRIDO DE TODOS LOS COBRADORES
                    ...
                    if($tipoServicio == "A") {
                        ...
                        if ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
                            ...
                            $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND idColonia= '".$colonia."' AND cobradoPor= '".$cobradorR."' AND anulada= '".$anulada."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);
                        }
                    }elseif ($tipoServicio == "C") {
                        if ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
        ...
        if ($tipoServicio == "C") {
            //SQL para todas las zonas de cobro
            if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND tipoServicio= '".$tipoServicio."' AND anulada= '".$anulada."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                $resultado = $mysqli->query($query);
            }elseif ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] != "todas") {
                $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND idColonia= '".$colonia."' AND tipoServicio= '".$tipoServicio."' AND anulada= '".$anulada."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                $resultado = $mysqli->query($query);
            }elseif ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
                $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND cobradoPor= '".$codigoCobrador."' AND tipoServicio= '".$tipoServicio."' AND anulada= '".$anulada."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                $resultado = $mysqli->query($query);
            }else {
                $query = "SELECT * FROM tbl_abonos WHERE anticipado=1 AND cobradoPor= '".$codigoCobrador."' AND idColonia= '".$colonia."' AND tipoServicio= '".$tipoServicio."' AND anulada= '".$anulada."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                $resultado = $mysqli->query($query);
            }
        }elseif ($tipoServicio == "I") {
            //SQL para todas las zonas de cobro
        ...
        $pdf->Cell(20,5,utf8_decode('Tipo serv'),1,0,'L');
        $pdf->Cell(20,5,utf8_decode('Abonado'),1,0,'L');*/
        $pdf->Cell(260,5,utf8_decode('RESUMEN GENERAL DE ANTICIPOS LIQUIDADOS DEL '.$desde." AL ".$hasta),'B',1,'C');
        $pdf->Ln(6);
        /*$pdf->SetFont('Arial','B',6.5);
        $pdf->Cell(35,1,utf8_decode('TOTAL VENTAS MANUALES:'),0,0,'L');
        $pdf->Cell(18,1,utf8_decode(number_format($result3,2)),0,1,'L');
