...
if ($tipoComprobante == 2) {
    ...
    //*******************************FACTURA NORMAL**********************************
      ...
      {    //if ($row['idMunicipio'] != "0301"){var_dump($row["codigoCliente"]." ".$row["idMunicipio"]);}
        ...
        $pdf->AliasNbPages();
        $pdf->AddPage();
        $pdf->Image('../../../images/f_final.jpg',-2,-2,335, 219);
        $pdf->Image('../../../images/comp.png',160,110, 45, 10);//120
        if ($row["anulada"] == 1){
        ...
        if ($row['tipoServicio'] == "C") {
            $pdf->Image('../../../images/cable.png',50,90, 15, 17);//100
            $pdf->Image('../../../images/cable.png',175,90, 15, 17);//100
            $pdf->Image('../../../images/cable.png',275,90, 15, 17);//100
        ...
        elseif ($row['tipoServicio'] == "I") {
            $pdf->Image('../../../images/inter.png',50,90, 15, 17);
            $pdf->Image('../../../images/inter.png',175,90, 15, 17);
            $pdf->Image('../../../images/inter.png',275,90, 15, 17);
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
        ...
        $pdf->Cell(65,6,utf8_decode($row['codigoCliente']),0,0,'L');
        ...
        $pdf->Cell(72,6,utf8_decode($row['codigoCliente']),0,0,'L');
        $pdf->Cell(-8,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,6,utf8_decode(strftime('%d', strtotime($row['fechaFactura']))." de ".strftime('%B', strtotime($row['fechaFactura'])). " de ".strftime('%G', strtotime($row['fechaFactura']))),0,0,'L');
        $pdf->Cell(1,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,19,utf8_decode(strftime('%d', strtotime($row['fechaFactura']))." de ".strftime('%B', strtotime($row['fechaFactura'])). " de ".strftime('%G', strtotime($row['fechaFactura']))),0,1,'L');
        $pdf->Ln(-14.5);
        $pdf->Cell(7,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,6,utf8_decode($row['nombre']),0,0,'L');
        $pdf->Cell(53,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,6,utf8_decode($row['nombre']),0,1,'L');
        $pdf->Cell(8,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(30,4,utf8_decode($direccion),0,0,'L');
        $pdf->Cell(95,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,4,utf8_decode($direccion),0,1,'L');

        $pdf->Ln(-5);
        $pdf->Cell(250,6,utf8_decode(''),0,0,'L');
        //COD CLIENTE 3RA COLUMNA
        $pdf->Cell(70,11,utf8_decode($row['codigoCliente']),0,1,'L');
        $pdf->Ln(10);
        $pdf->Cell(8,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,-30,utf8_decode($municipio),0,0,'L');
        $pdf->Cell(55,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,-30,utf8_decode($municipio),0,0,'L');
        $pdf->Cell(48,6,utf8_decode(''),0,0,'L');

        $pdf->Cell(70,-22.5,utf8_decode($row['nombre']),0,1,'L');
        $pdf->Ln(10);
        //TELEFONO
        $pdf->Cell(60,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(105,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(60,24,utf8_decode($direccion),0,1,'L');
        $pdf->Ln(15);
    //////////////////////////////FIN FRANJA 1///////////////////////////////////
        ...
        $pdf->Cell(-11,6,utf8_decode('1'),0,0,'R');
        $pdf->Cell(35,6,utf8_decode("Pendiente ".strftime('%B', strtotime($row['fechaCobro'])). " de ".strftime('%Y', strtotime($row['fechaCobro']))),0,0,'L');
        ...
        $pdf->Cell(253,6,utf8_decode(''),0,0,'L');
        $pdf->Cell(70,-55,utf8_decode($municipio),0,1,'L');
        $pdf->Ln(19);
        $pdf->Cell(260,6,utf8_decode(''),0,1,'L');
        $pdf->Ln(10);
    //////////////////////////////INICIO FRANJA 2 ///////////////////////////////
        $pdf->SetFont('Arial','B',7);
        $pdf->Cell(-3,6,utf8_decode(''),0,0,'L');
        ...
        $pdf->Cell(285,6,utf8_decode(''),0,0,'L');
        $pdf->SetFont('Arial','',7);
        $pdf->Cell(70,55,utf8_decode('VENCE: '.date_format(date_create($row['fechaVencimiento']), 'd/m/Y')),0,1,'L');
        //$pdf->Ln(55);
        $pdf->SetFont('Arial','B',10);
        ...
        if ($row['exento'] != "T") {
            ...
            $pdf->Cell(70,6,utf8_decode("$".number_format($unitario,2)),0,0,'L');
            $pdf->Cell(52,6,utf8_decode(''),0,0,'L');
            $pdf->Cell(70,6,utf8_decode("$".number_format($unitario,2)),0,1,'L');
            $pdf->Ln(-2);
            $pdf->Cell(96,6,utf8_decode(''),0,0,'L');
            ...
            $pdf->Cell(48,6,utf8_decode($numeroALetras),0,0,'C');
