...
$contadorDeFilas=1;
$counter1=1;
/// Condicional de los cobradores
if ($cobrador == 'todos') {
  # code...
/// Condicional de los estados de los clientes de todos los cobradores...
if ($Tipocliente=='A') {
  # codigo para solo activos de todos los cobradores...
if ($tipoServicio == 'T') {
  $sql3 = "SELECT cod_cliente FROM clientes WHERE (servicio_suspendido='F' or servicio_suspendido is null or servicio_suspendido='') and sin_servicio='F' OR estado_cliente_in = 1 AND cod_cliente<>'00000'";
$resultado3 = $mysqli->query($sql3);
 while ($row3 = $resultado3->fetch_assoc()){
//var_dump($row3['cod_cliente']);
        $sql1 = "SELECT codigoCliente, COUNT(codigoCliente) FROM tbl_cargos WHERE fechaFactura BETWEEN '$nDesde' AND '$nHasta' AND estado='pendiente' and anulada='0' and codigoCliente='".$row3["cod_cliente"]."' GROUP by codigoCliente HAVING COUNT(*)>3";
...
$resultado3 = $mysqli->query($sql3);
 while ($row3 = $resultado3->fetch_assoc()){
//var_dump($row3['cod_cliente']);
        $sql1 = "SELECT codigoCliente, tipoServicio, COUNT(codigoCliente) FROM tbl_cargos WHERE fechaFactura BETWEEN '$nDesde' AND '$nHasta' AND estado='pendiente' and anulada='0' AND tipoServicio='$tipoServicio' and codigoCliente='".$row3["cod_cliente"]."' GROUP by codigoCliente HAVING COUNT(*)>1";
...
}elseif ($Tipocliente=='S') {
  # codigo para solo suspendidos de todos los cobradores...
if ($tipoServicio == 'T') {
   $sql3 = "SELECT cod_cliente FROM clientes WHERE servicio_suspendido='T' AND sin_servicio='F' AND estado_cliente_in = 3";
$resultado3 = $mysqli->query($sql3);
 while ($row3 = $resultado3->fetch_assoc()){
        $sql1 = "SELECT codigoCliente, COUNT(codigoCliente) FROM tbl_cargos WHERE fechaFactura BETWEEN '$nDesde' AND '$nHasta' AND estado='pendiente' and anulada='0' and codigoCliente='".$row3["cod_cliente"]."' GROUP by codigoCliente HAVING COUNT(*)>3";
...
$counter1++;
 ...
 putenv("LANG='es_ES.UTF-8'");
  ...
  $sql3 = "SELECT cod_cliente FROM clientes WHERE servicio_suspendido='T' AND sin_servicio='F'";
$resultado3 = $mysqli->query($sql3);
 while ($row3 = $resultado3->fetch_assoc()){
  //var_dump($row3["cod_cliente"]);
        $sql1 = "SELECT codigoCliente, tipoServicio, COUNT(codigoCliente) FROM tbl_cargos WHERE fechaFactura BETWEEN '$nDesde' AND '$nHasta' AND estado='pendiente' and anulada='0' AND tipoServicio='$tipoServicio' and codigoCliente='".$row3["cod_cliente"]."' GROUP by codigoCliente HAVING COUNT(*)>1";
...
}elseif ($Tipocliente=='T'){
  # codigo para todos los suspendidos y activos de todos los cobradores...
  if ($tipoServicio == 'T') {
...
$resultado1 = $mysqli->query($sql1);
 while ($row1 = $resultado1->fetch_assoc()){
  ...
  if ($row1['COUNT(codigoCliente)'] >= '2') {
   ...
   // var_dump($codigoValido);
 $sql = "SELECT codigoCliente, nombre, direccion, tipoServicio, mesCargo, numeroFactura, cuotaInternet, cuotaCable, fechaVencimiento FROM tbl_cargos WHERE fechaFactura BETWEEN '$nDesde' AND '$nHasta' AND estado='pendiente' and anulada='0' AND tipoServicio='$tipoServicio' AND codigoCliente= '$codigoValido'";
...
/////////
/// Condicional de cobrador en especifico
/////////
}else{
  # code...
  /// Condicional de los estados de los clientes de un cobrador en especifico...
if ($Tipocliente=='A') {
  # codigo para solo activos de un cobrador en especifico...
}elseif ($Tipocliente=='S') {
  # codigo para solo suspendidos de un cobrador en especifico...
}else{
  # codigo para todos los suspendidos y activos de un cobrador en especifico...
  if ($tipoServicio == 'T') {
...
$resultado1 = $mysqli->query($sql1);
 while ($row1 = $resultado1->fetch_assoc()){
  ...
  if ($row1['COUNT(codigoCliente)'] >= '2') {
   ...
   // var_dump($codigoValido);
 $sql = "SELECT codigoCliente, nombre, direccion, tipoServicio, mesCargo, numeroFactura, cuotaInternet, cuotaCable, fechaVencimiento FROM tbl_cargos WHERE fechaFactura BETWEEN '$nDesde' AND '$nHasta' AND estado='pendiente' and anulada='0' AND tipoServicio='$tipoServicio' and codigoCobrador='$cobrador'  AND codigoCliente= '$codigoValido'";
