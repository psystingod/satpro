...
/*
$query = "SELECT codigoCliente, mesCargo FROM tbl_cargos WHERE fechaFactura ='".$hasta."'";
                      $resultado = $mysqli->query($query);
                        ...
                        */
 ///// Comprobacion si el resultado de mesCargof trae un valor, si no lo trae cambiara a 0000-00-00 para no salir con error el resultado
   /*                   
if (!isset($mesCargof)) {
  $mesCargof = '0000-00-00';
}
*/
        if (isset($detallado)){
          if ($detallado == 1){
              ...
              if ($tipoServicio == "C") {
                ...
                /*
                $query = "SELECT codigoCliente, mesCargo FROM tbl_cargos WHERE fechaFactura ='".$hasta."' AND tipoServicio= '".$tipoServicio."'";
                      $resultado = $mysqli->query($query);
                       while($row = $resultado->fetch_assoc())
                       {
                        $codigoCliente = $row['codigoCliente'];
        ...
        $query10 = "SELECT mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' GROUP BY fechaFactura";
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                      $query = "SELECT * FROM tbl_abonos WHERE tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                      $resultado = $mysqli->query($query);
                    }
                    ...
                    $query10 = "SELECT mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' GROUP BY fechaFactura";
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                      $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                      $resultado = $mysqli->query($query);
                    }
                  }elseif ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
                    $query10 = "SELECT mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' GROUP BY fechaFactura";
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                      $query = "SELECT * FROM tbl_abonos WHERE cobradoPor= '".$codigoCobrador."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                      $resultado = $mysqli->query($query);
                    }
                  }else {
                    $query10 = "SELECT mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' GROUP BY fechaFactura";
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                      $query = "SELECT * FROM tbl_abonos WHERE cobradoPor= '".$codigoCobrador."' AND idColonia= '".$colonia."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                      $resultado = $mysqli->query($query);
                    }
                  }
              ...
              */
              if ($codigoCobrador === "todos") {
                ...
                *//// finalizacion de obtenencion de datos de la tabla cargos para liquidar los abonos
                          ...
                          if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                            //////////////////////////////////////////////////////////
                            $query10 = "SELECT mesCargo, codigoCliente, tipoServicio FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' AND anulada = '0' AND codigoCobrador= '".$cobradorR."'";
                      $resultado10 = $mysqli->query($query10);
                       while($row1 = $resultado10->fetch_assoc())
      {
       // $mesCargof = $row1['mesCargo'];
       //var_dump($row1['mesCargo']);
                              //var_dump($row1['codigoCliente']);
                              //var_dump($row1['tipoServicio']);
        
                              $query = "SELECT * FROM tbl_abonos WHERE anticipado= '".$anticipado."' AND cobradoPor= '".$cobradorR."' AND mesCargo= '".$row1['mesCargo']."' AND codigoCliente= '".$row1['codigoCliente']."' AND tipoServicio= '".$row1['tipoServicio']."'";
                              $resultado = $mysqli->query($query);
                              //var_dump($row1['mesCargo']);
                              //var_dump($row1['codigoCliente']);
                      ...
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                              $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND codigoCobrador= '".$cobradorR."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                            }
                          }
                ...
                */
                      ...
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                              $query = "SELECT * FROM tbl_abonos WHERE codigoCliente!= '".$recibo_anulado."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND cobradoPor= '".$cobradorR."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                            }
                          }elseif ($_POST["lCobrador"] == "todos" && $_POST["lColonia"] != "todas") {
                            $query10 = "SELECT mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' GROUP BY fechaFactura";
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                              $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND cobradoPor= '".$cobradorR."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                          }
                        }
                      }elseif ($tipoServicio == "I") {
...
/*
                      ...
                      if ($controlCobrador == $cobradores["codigoCobrador"] && $controlCobrador != $row["cobradoPor"]) {
                          ...
                          $pdf->Cell(20,5,'$ '.number_format($totalAnticipoCobrador,2),"T",1,'L');
              ...
              if ($codigoCobrador != "todos") {
                ...
                *//// finalizacion de obtenencion de datos de la tabla cargos para liquidar los abonos
                      ...
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                              $query = "SELECT * FROM tbl_abonos WHERE codigoCliente!= '".$recibo_anulado."' AND cobradoPor= '".$cobradorR."' AND anticipado= '".$anticipado."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                            }
                          }elseif ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] != "todas") {
                            $query10 = "SELECT mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' GROUP BY fechaFactura";
                      $resultado10 = $mysqli->query($query10);
                       while($row = $resultado10->fetch_assoc())
      {
                              $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND cobradoPor= '".$cobradorR."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$row['mesCargo']."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                            }
                          }
                      }elseif ($tipoServicio == "C") {
...
/*
            ...
            if ($tipoServicio == "C") {
                              ///// inicio de obtenencion de datos de la tabla cargos para liquidar los abonos
              /*
                $query = "SELECT codigoCliente, mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' AND tipoServicio= '".$tipoServicio."'";
                      $resultado = $mysqli->query($query);
                       while($row = $resultado->fetch_assoc())
                       {
                        $codigoCliente = $row['codigoCliente'];
                ...
                //SQL para todas las zonas de cobro
                if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                    $query = "SELECT * FROM tbl_abonos WHERE tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                    $resultado = $mysqli->query($query);
                }elseif ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] != "todas") {
                    $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                    $resultado = $mysqli->query($query);
                }elseif ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
                    $query = "SELECT * FROM tbl_abonos WHERE cobradoPor= '".$codigoCobrador."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                    $resultado = $mysqli->query($query);
                }else {
                    $query = "SELECT * FROM tbl_abonos WHERE cobradoPor= '".$codigoCobrador."' AND idColonia= '".$colonia."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                    $resultado = $mysqli->query($query);
                }
            }elseif ($tipoServicio == "I") {
                              ///// inicio de obtenencion de datos de la tabla cargos para liquidar los abonos
           ...
           // $pdf->Cell(20,5,number_format(($tmc+$tic+$tmi+$tii),2),"BTR",1,'L',1);
            ...
            if ($codigoCobrador === "todos") {
                ...
                while ($cobradores = $statement1->fetch_assoc()) {//RECORRIDO DE TODOS LOS COBRADORES
                    ...
                    if($tipoServicio == "A") {
                                      ///// inicio de obtenencion de datos de la tabla cargos para liquidar los abonos
                      /*
                $query = "SELECT codigoCliente, mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."'";
                      $resultado = $mysqli->query($query);
                       while($row = $resultado->fetch_assoc())
                       {
                        $codigoCliente = $row['codigoCliente'];
                        ...
                        */
                        ...
                        //SQL para todas las zonas de cobro
                        if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                            $query = "SELECT * FROM tbl_abonos WHERE codigoCliente!= '".$recibo_anulado."' AND cobradoPor= '".$cobradorR."' AND anticipado= '".$anticipado."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);
                        }elseif ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] != "todas") {
                            $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND codigoCobrador= '".$cobradorR."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);
                        }
                    }elseif ($tipoServicio == "C") {
                                      ///// inicio de obtenencion de datos de la tabla cargos para liquidar los abonos
                ...
                $query = "SELECT codigoCliente, mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' AND tipoServicio= '".$tipoServicio."'";
                      $resultado = $mysqli->query($query);
                        ...
                        */
                        ///// finalizacion de obtenencion de datos de la tabla cargos para liquidar los abonos
                        if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                            $query = "SELECT * FROM tbl_abonos WHERE codigoCliente!= '".$recibo_anulado."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND cobradoPor= '".$cobradorR."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);
                        }elseif ($_POST["lCobrador"] == "todos" && $_POST["lColonia"] != "todas") {
                            $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND cobradoPor= '".$cobradorR."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND codigoCliente!= '".$recibo_anulado."' AND mesCargo= '".$mesCargof."' ORDER BY numeroRecibo ASC";
                            $resultado = $mysqli->query($query);
                        }
                    }elseif ($tipoServicio == "I") {
                                      ///// inicio de obtenencion de datos de la tabla cargos para liquidar los abonos
                ...
                $query = "SELECT codigoCliente, mesCargo FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' AND tipoServicio= '".$tipoServicio."'";
                    ...
                    if ($controlCobrador == $cobradores["codigoCobrador"] && $controlCobrador != $row["cobradoPor"]) {
                        ...
                        $pdf->Cell(50,4,number_format($totalAnticipoCobradorCable,2),"T",1,'L');
                        ...
                        $pdf->Cell(50,4,number_format($totalAnticipoCobradorInter,2),"T",1,'L');
                        ...
                        $pdf->Cell(20,5,'$ '.number_format($totalAnticipoCobrador,2),"T",1,'L');
                        $pdf->Cell(15,5,number_format(($totalImpuestosCobrador),2),"T",0,'L');*/
                        $pdf->Cell(20,5,number_format(($totalAnticipoCobrador),2),"BTR",1,'L',1);
                        $pdf->Ln(3);
                        ...
                        if ($counter2 > 6){
                            ...
                            $pdf->Cell(190, 4, utf8_decode('CABLE VISION POR SATELITE, S.A DE C.V.'), 0, 1, 'L');
                            $pdf->SetFont('Arial', 'B', 7);
                            $pdf->Cell(190, 4, utf8_decode('LISTADO DE ABONOS ANTICIPADOS'), 0, 1, 'L');
                            if ($_SESSION['db'] == 'satpro_sm'){
                                $pdf->Cell(190, 4, utf8_decode('SUCURSAL SAN MIGUEL'), 0, 1, 'L');
            ...
            $pdf->Cell(185,4,utf8_decode(''),0,0,'R');
            $pdf->Cell(115,4,utf8_decode(''),"",1,'R');
            ...
            $pdf->SetFont('Arial','',8);
            //TOTAL INTERNET
            $pdf->Cell(115,4,utf8_decode('TOTAL INTERNET: '),0,0,'R');
            //$pdf->Cell(20,4,number_format($totalSoloInter,2),"T",0,'L');
            $pdf->Cell(20,4,'+ '.number_format($totalAnticipoSoloInter,2),"T",1,'L');
            //$pdf->Cell(15,4,number_format(($totalAnticipoImpuestoI+$totalImpuestoI),2),"T",0,'L');
            //$pdf->Cell(25,4,"+ ".number_format(($totalSoloInter+$totalAnticipoSoloInter+$totalAnticipoImpuestoI+$totalImpuestoI),2),"T",1,'L');
            ...
            //TOTAL CABLE
            $pdf->Cell(115,4,utf8_decode('TOTAL CABLE: '),0,0,'R');
            //$pdf->Cell(20,4,number_format($totalSoloCable,2),"T",0,'L');
            $pdf->Cell(20,4,'+ '.number_format($totalAnticipoSoloCable,2),"T",1,'L');
            //$pdf->Cell(15,4,number_format(($totalAnticipoImpuestoC+$totalImpuestoC),2),"T",0,'L');
            //$pdf->Cell(25,4,"+ ".number_format(($totalSoloCable+$totalAnticipoSoloCable+$totalAnticipoImpuestoC+$totalImpuestoC),2),"T",1,'L');
            ...
            //TOTAL IMPUESTO
            $pdf->Cell(115,4,utf8_decode('TOTAL GENERAL: '),"",0,'R');
            //$pdf->Cell(20,4,number_format(($totalSoloCable+$totalSoloInter),2),"T",0,'L');
            $pdf->Cell(20,4,'= '.number_format(($totalAnticipoSoloCable+$totalAnticipoSoloInter),2),"T",1,'L');
            $pdf->Cell(115,4,utf8_decode(''),"",0,'R');
            $pdf->Cell(20,4,utf8_decode(''),"T",1,'L');
            //$pdf->Cell(15,4,utf8_decode(number_format(($totalAnticipoImpuestoC+$totalImpuestoC+$totalAnticipoImpuestoI+$totalImpuestoI),2)),"T",0,'L');
            $pdf->SetFont('Arial','B',8);
            //$pdf->Cell(25,4,"= ".number_format(($totalSoloCable+$totalSoloInter+$totalAnticipoSoloCable+$totalAnticipoSoloInter+$totalAnticipoImpuestoC+$totalImpuestoC+$totalAnticipoImpuestoI+$totalImpuestoI),2),"T",1,'L');
