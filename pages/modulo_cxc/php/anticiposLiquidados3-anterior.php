              ...
              */
              if ($codigoCobrador === "todos") {
                ...
                *//// finalizacion de obtenencion de datos de la tabla cargos para liquidar los abonos
                          ...
                          if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                            //////////////////////////////////////////////////////////
                            $query10 = "SELECT mesCargo, codigoCliente FROM tbl_cargos WHERE fechaFactura BETWEEN '".$desde."' AND '".$hasta."' AND anulada = '0' AND codigoCobrador= '".$cobradorR."'";
                      $resultado10 = $mysqli->query($query10);
                       while($row1 = $resultado10->fetch_assoc())
      {
       // $mesCargof = $row1['mesCargo'];
       
                              $query = "SELECT * FROM tbl_abonos WHERE codigoCliente!= '".$recibo_anulado."' AND cobradoPor= '".$cobradorR."' AND anticipado= '".$anticipado."' AND mesCargo= '".$row1['mesCargo']."' AND codigoCliente= '".$row1['codigoCliente']."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
