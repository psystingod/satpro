            ...
            <div class="row">
                <div class="col-md-8">
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <td><a onclick="window.open('php/contratoCable.php<?php echo "?id=".$id; ?>','','height=600,width=1000,top=-300,left=200')" class="btn btn-danger btn-block" style="font-size: 16px;"><i class="far fa-file-alt"></i> Generar contrato Cable</a></td>
                            <!-- -->
                            <td><button class="btn btn-danger btn-block" data-toggle="modal" data-target="#nuevoContratoI" onclick="comprobarI();"><i class="far fa-file-alt" style=" font-size: 16px;"></i> Gestion de Contratos</button></td>
                            <!-- -->
...
<!-- CONTRATOS MENU DE OPCIONES PARA SELECCION DE CONTRATOS -->
<style>
    /*
Full screen Modal 
*/
...
<div id="nuevoContratoI" class="modal fullscreen-modal fade" role="dialog">
            ...
            <!-- Modal body -->
                ...
                <br><br><br><br>
                <a onclick="window.open('php/contratoInterDigitalN.php<?php echo "?id=".$id; ?>','','height=600,width=1000,top=-300,left=200')" class="btn btn-danger btn-block" style="font-size: 16px;"><i class="far fa-file-alt"></i> Generar contrato parte frontal</a>
                <br><br>
                <a onclick="window.open('php/contratoInterDigitalN-2.php<?php echo "?id=".$id; ?>','','height=600,width=1000,top=-300,left=200')" class="btn btn-danger btn-block" style="font-size: 16px;"><i class="far fa-file-alt"></i> Contrato parte posterior</a>
                 </div>
                <!-- Modal footer -->
                <div class="modal-footer">
<script>
    function comprobarI() {
        ...
        ?>
        {
            ...
            imprimirI.disabled = "false";
        }

    } else{
        var imprimirI = document.getElementById("imprimir");
            imprimirI.disabled = "true";
    }

</script>
                    <div class="row">
                        <div class="col-sm-6 text-left">
                             <button type="button" id="imprimir" class="btn btn-secondary">Reimprimir contrato</button>
                        </div>
...
<!-- FINAL DE CONTRATOS MENU DE OPCIONES PARA SELECCION DE CONTRATOS -->
    <!-- /#wrapper -->
