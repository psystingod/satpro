...
var prepagoCable = document.getElementById("prepagoCable").value;
var prepagoInter = document.getElementById("prepagoInter").value;
...
if (document.getElementById("servicio").value == "c") {
    document.getElementById("valorCuota").value = prepagoCable;
     document.getElementById("totalPagar").value = prepagoCable;
}else if (document.getElementById("servicio").value == "i") {
    document.getElementById("valorCuota").value = prepagoInter;
     document.getElementById("totalPagar").value = prepagoInter;
}
 ...
 if (document.getElementById("servicio").value == "c") {
    document.getElementById("valorCuota").value = cuotaCable;
     document.getElementById("totalPagar").value = cuotaCable;
}else if (document.getElementById("servicio").value == "i") {
    document.getElementById("valorCuota").value = cuotaInter;
     document.getElementById("totalPagar").value = cuotaInter;
}
    }
}
...
function xmesesCancelar(){
    if (document.getElementById("mesx1") != null && document.getElementById("mesx2") != null){
     ...
     // document.getElementById("impSeg").value = parseFloat(totalCesc) * parseFloat(xmeses);
        document.getElementById("impSeg").value =Number(parseFloat(totalCesc) * parseFloat(xmeses)).toFixed(2);

        var val_cuota = document.getElementById("valorCuota").value;
        document.getElementById("totalPagar").value = parseFloat(val_cuota) * parseFloat(xmeses);
        document.getElementById("totalAbonoImpSeg").value = parseFloat(document.getElementById("impSeg").value) + parseFloat(document.getElementById("totalPagar").value);
