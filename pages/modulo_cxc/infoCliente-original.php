                ...
                <div class="col-md-8">
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td><a onclick="window.open('php/contratoInterDigitalN.php<?php echo "?id=".$id; ?>','','height=600,width=1000,top=-300,left=200')" class="btn btn-danger btn-block" style="font-size: 16px;"><i class="far fa-file-alt"></i> Generar contrato Internet F</a></td>
